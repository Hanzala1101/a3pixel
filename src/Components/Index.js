                    ...
                    <section id="call-to-action cta " className="call-to-action zoom-out yellow">
                        ...
                        <div className="container">
                            ...
                            <div className="row" data-aos="zoom-out">
                                ...
                                <div className="col-lg-3 cta-btn-container text-center my-auto">
                            ...
                            <div className="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div>
                                    <ul className="portfolio-flters " >
                                        ...
                                        <li data-filter=".filter-app">E-LEARNING</li>
                                        <li data-filter=".filter-product">LOCALIZATION</li>
                                        <li data-filter=".filter-branding">WEB DESIGN</li>
                                        <li data-filter=".filter-books">MOBILE SOLUTION</li>
                                        <li data-filter=".filter-books1">MULTIMEDIA PRESENTATION</li>
                                        <li data-filter=".filter-books2">LOGO & PRINT DESIGN</li>
                                    </ul>
